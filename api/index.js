...
app.use(cors({ credentials: true, origin: 'https://recipe-first-site-8g48dsqka-eclarkhalid.vercel.app' }));

const corsOptions = {
  credentials: true,
  origin: 'https://recipe-first-site-8g48dsqka-eclarkhalid.vercel.app',
};
