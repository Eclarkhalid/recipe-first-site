    ...
    <div className="p-4 md:p-8 lg:p-12">
      <div className="flex flex-col md:flex-row justify-between items-center mb-4">
        <input
          ...
          className="border border-gray-300 rounded-md p-2 w-full md:w-[400px] outline-blue-600 mb-2 md:mb-0"
        />
        <select
          value={selectedAuthor}
          onChange={(e) => setSelectedAuthor(e.target.value)}
          className="border border-gray-300 rounded-md p-2 cursor-pointer outline-blue-400 w-full md:w-auto"
        >
